...
<section id="home">
    <div class="container"> 
     ...
     <!-- Adding the wavy animation element -->
     <div id="wave"></div>
...
<section id="brand" class="container">
    <div class="row">
        <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="assets/images/b1.jpg" alt="">
        <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="assets/images/b2.jpg" alt="">
        <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="assets/images/b3.jpg" alt="">
        <img class="img-fluid col-lg-3 col-md-6 col-sm-12" src="assets/images/b4.jpg" alt="">
    </div>
</section>
...
<section id="new" class="w-100">
    ...
    <div class="one col-lg-6 col-md-12 col-sm-12 p-0 my-2">
...
<section id="featured" class="my-5 pb-5">
    <div class="container text-center mt-5 py-5">
        ...
        <p>We’ve picked few pieces we’re pretty sure you’ll love.
