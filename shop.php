...
<section id="shop" class="my-5 pb-5">
    <div class="container mt-5 py-5 text-center">
        <h3 style="margin-top: 5%;">Our Products</h3>
    ...
    <div class="row mx-auto container">
        ...
        <div class="product text-center col-lg-3 col-md-4 col-sm-12">
            ...
            <h5 class="p-name" style="height: 50px;" ><?php echo $row['product_name']; ?> </h5>
            <h4 class="p-price" style="height: 20px;">$ <?php echo $row['product_price']; ?></h4>
